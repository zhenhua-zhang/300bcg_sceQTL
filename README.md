...
### 4.1 Single-cell RNA-seq analysis and cell type identification
  - Read counts generated by `cellranger` pipeline (**version?**)
...
### 4.10 Replication of the identified eQTLGen
...
<!--
atac_seq.r
check_eqtl_per_condition.r
check_longcovid.r
coexpression.r
enrich.r
convert_seurat_into_loom.r
-->
collect_top_eqtl.r
explore_coloc.r
prepare_inputs_limix_eqtl.r
reformat_gse184269.r
...
| Genomic features | Gencode/GRCh38   |              |          |
| ADASTRA          | V5.1.3           | https://adastra.autosome.org/bill-cipher | |
| GeneHancer       | UCSC Genome Browser | |
| DICE             |                  |              |          |
| GTEx             |                  |              |          |
| eQTLGen          |                  |              |          |
